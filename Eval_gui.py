...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 687, 884))
        ...
        MainWindow.setTabOrder(self.pushB_Exit, self.scrollArea)
        MainWindow.setTabOrder(self.scrollArea, self.pushBf_fabs)
        ...
        MainWindow.setTabOrder(self.pushBf_log, self.pushBf_log10)
        MainWindow.setTabOrder(self.pushBf_log10, self.pushBf_log2)
        MainWindow.setTabOrder(self.pushBf_log2, self.pushBf_pow)
        MainWindow.setTabOrder(self.pushBf_pow, self.pushBf_sqrt)
        MainWindow.setTabOrder(self.pushBf_sqrt, self.pushBf_acos)
        MainWindow.setTabOrder(self.pushBf_acos, self.pushBf_asin)
        MainWindow.setTabOrder(self.pushBf_asin, self.pushBf_atan)
        MainWindow.setTabOrder(self.pushBf_atan, self.pushBf_atan2)
        MainWindow.setTabOrder(self.pushBf_atan2, self.pushBf_cos)
        MainWindow.setTabOrder(self.pushBf_cos, self.pushBf_sin)
        MainWindow.setTabOrder(self.pushBf_sin, self.pushBf_tan)
        MainWindow.setTabOrder(self.pushBf_tan, self.pushBf_cosh)
        MainWindow.setTabOrder(self.pushBf_cosh, self.pushBf_sinh)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.textCalc.setToolTip(_translate("MainWindow", "<html><head/><body><p>Поле для ввода выражения. В вырадении можно задавать функции. Подробный синтаксический контроль выражения не производится. Если выражение задано неверно, или аргумент имеет недопустимое значение, то при расчете в поле Результат выдается сообщение: <span style=\" font-weight:600;\">Ошибка в выражении и/или аргументах</span></p></body></html>"))
        ...
        self.pushBf_fabs.setText(_translate("MainWindow", "fabs(X) - модуль X"))
        self.pushBf_factorial.setText(_translate("MainWindow", "factorial(X) - факториал числа X"))
        self.pushBf_exp.setText(_translate("MainWindow", "exp(X) - eX (e в степени X)"))
        ...
        self.pushBf_log2.setText(_translate("MainWindow", "log2(X) - логарифм X по основанию 2"))
        ...
        self.pushBf_acos.setText(_translate("MainWindow", "acos(X) - арккосинус X"))
        self.pushBf_asin.setText(_translate("MainWindow", "asin(X) - арксинус X"))
        self.pushBf_atan.setText(_translate("MainWindow", "atan(X) - арктангенс X"))
        ...
        self.pushBf_tan.setText(_translate("MainWindow", "tan(X) - тангенс X"))
        self.pushBf_cosh.setText(_translate("MainWindow", "cosh(X) - гиперболический косинус X"))
        self.pushBf_sinh.setText(_translate("MainWindow", "sinh(X) - гиперболический синус X"))
        self.pushBf_tanh.setText(_translate("MainWindow", "tanh(X) - гиперболический тангенс X"))
        self.pushBf_acosh.setText(_translate("MainWindow", "acosh(X) - обратный гиперболический косинус X"))
        self.pushBf_asinh.setText(_translate("MainWindow", "asinh(X) -  обратный гиперболический синус X"))
        self.pushBf_atanh.setText(_translate("MainWindow", "atanh(X) - обратный гиперболический тангенс X"))
